...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <div className=" flex flex-col items-center h-full justify-center">
      {/* The sliding header */}
      <div className="flex flex-row justify-center items-center w-full bg-gray-900 ">
        {/* Burger button */}
        <button
          onClick={() => setBurgerOnOff(!burgerOnOff)}
          className="bg-white bg-opacity-50 rounded sm:ml-4 ml-2 p-2 sm:w-15 sm:h-15 w-8 h-8 flex flex-col justify-between items-center space-y-1"
        >
